require "citizenry/search_engine/base"
require "citizenry/search_engine/sql"
require "citizenry/search_engine/thinking_sphinx"
...
module Citizenry
  module SearchEngine
    ...
    def self.implementation
      begin
        return "Citizenry::SearchEngine::#{self.kind.to_s.classify}".constantize
      rescue NameError
